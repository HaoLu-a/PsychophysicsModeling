...
# Convert accuracy to success and failure count
CI_data$Accuracy = CI_data$Accuracy/100
CI_data$Response = cbind(CI_data$Accuracy * 80,(1-CI_data$Accuracy)*80)

#default contrast setting does not satisfy type-III anova assumption
...
Considering sample size and our general assumption, the best full model we can fit is the model with random intercept for each participant. Two GLMMs were fitted for experiment 1 and experiment 2.
